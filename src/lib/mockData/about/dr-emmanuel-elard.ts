export const mockdrData = {
  home: {
    seo: {
      title: 'Dr Emmanuel Elard | Médecin Esthétique Expert à Paris',
      description:
    ...
    expertise: {
      title: 'EXPERTISE ET RECONNAISSANCE',
      items: [
        {
          icon: 'graduationCap',
          title: 'Formation',
          description:
            "Diplôme Inter-Universitaire en Techniques d'Injection\nMaster en Médecine Anti-Âge",
        },
        {
          icon: 'users',
          title: 'Formateur',
          description:
            "Enseignant au DU/DIU à l'Université Paris XII\nFormateur auprès des professionnels en techniques d'injection",
        },
        {
          icon: 'award',
          title: 'Reconnaissance',
          description: "Prix de l'Innovateur de l'Année 2023\nAesthetic Awards",
        },
      ],
    },
    qualifications: {
    ...
    contact: {
      ...
      email: 'contact@dr-emmanuel-elard.fr',
      coordinates: {
        latitude: 48.8566,
        longitude: 2.3522,
      },
      googleMapsUrl:
        'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2624.9902516231344!2d2.3522213156746196!3d48.856614079287336!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xabcdef1234567890!2sDr%20Emmanuel%20Elard%20-%20M%C3%A9decine%20Esth%C3%A9tique!5e0!3m2!1sfr!2sfr!4v1614708291234!5m2!1sfr!2sfr',
    },
  },
};