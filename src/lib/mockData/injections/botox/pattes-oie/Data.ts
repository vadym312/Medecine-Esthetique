export const pattesOieData = {
  hero: {
    title: "Pattes d'Oie",
    subtitle: "Traitement des rides au coin des yeux",
    backgroundImage: "https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?auto=format&fit=crop&q=80",
  },
  intro: {
    text: "Les pattes d'oie sont ces petites rides qui se forment au coin des yeux lorsque l'on sourit. Notre traitement par toxine botulique permet de les atténuer tout en préservant votre expressivité naturelle.",
  },
  types: {
    ...
    items: [
      {
        ...
        description: "Traitement préventif des rides du sourire.",
        imageUrl: "https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?auto=format&fit=crop&q=80",
      },
      {
        title: "Rides Installées",
        description: "Correction des rides marquées au repos.",
        imageUrl: "https://images.unsplash.com/photo-1508215885820-4585e56135c8?auto=format&fit=crop&q=80",
      },
    ],
  },
  procedure: {
  ...
  video: {
    title: "Le traitement des pattes d'oie en vidéo",
    videoId: "yyQ30IDZFFA",
  },
  results: {
    title: "Résultats",
  ...
  faq: {
    ...
    subtitle: "Tout savoir sur le traitement des pattes d'oie",
    items: [
      {
