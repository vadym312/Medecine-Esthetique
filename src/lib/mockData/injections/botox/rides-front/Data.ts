export const ridesFrontData = {
  hero: {
    ...
    subtitle: "Traitement des rides horizontales frontales",
    backgroundImage: "https://images.unsplash.com/photo-1600334129128-685c5582fd35?auto=format&fit=crop&q=80",
  },
  intro: {
    text: "Le traitement des rides du front par injection de toxine botulique permet d'atténuer les rides horizontales tout en préservant une expressivité naturelle du visage.",
  },
  types: {
    ...
    items: [
      {
        ...
        description: "Traitement préventif des rides fines d'expression.",
  ...
  video: {
    title: "Le traitement des rides du front en vidéo",
    videoId: "yyQ30IDZFFA",
  },
  results: {
    title: "Résultats",
  ...
  faq: {
    ...
    subtitle: "Tout savoir sur le traitement des rides du front",
    items: [
      {
