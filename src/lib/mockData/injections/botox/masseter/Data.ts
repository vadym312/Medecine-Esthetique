export const masseterData = {
  ...
  types: {
    ...
    items: [
      ...
      },
      {
        ...
        imageUrl: "/images/injections/affiner-visage.webp",
      },
    ],
  },
  procedure: {
    ...
    steps: [
      {
        title: "Consultation",
        description: "Analyse de vos muscles masséters et définition de vos objectifs.",
      },
      {
        title: "Préparation",
      ...
      {
        title: "Injection",
        description: "Injection précise de toxine botulique dans les masséters.",
      },
      {
        title: "Suivi",
  ...
  video: {
    title: "Le traitement des masséters en vidéo",
    videoId: "yyQ30IDZFFA",
  },
  results: {
    title: "Résultats",
    ...
    items: [
      {
        ...
        location: "Paris",
        rating: 5,
        comment: "Un résultat très naturel qui a affiné mon visage. Plus de maux de tête liés au bruxisme.",
        date: "2024-03-15",
        treatment: "Masseter",
        verified: true,
      },
      {
        ...
        location: "Lyon",
        rating: 5,
        comment: "Très satisfait du résultat, mon visage est plus harmonieux et je dors mieux.",
        date: "2024-03-10",
        treatment: "Masseter",
        verified: true,
      },
