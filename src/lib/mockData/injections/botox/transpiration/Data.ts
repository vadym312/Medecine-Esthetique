export const transpirationData = {
    ...
    items: [
      {
        ...
        imageUrl: "/images/injections/transpiration-aisselles.webp",
      },
      {
        ...
        imageUrl: "/images/injections/hyperhydrose-palmaire.webp",
      },
      {
        ...
        imageUrl: "/images/injections/hyperhydros-epieds.webp",
      },
    ],
  },
  procedure: {
    ...
    steps: [
      {
        title: "Consultation",
        description: "Évaluation de votre hyperhidrose et définition de vos objectifs.",
      },
      {
        title: "Préparation",
        description: "Application d'une crème anesthésiante si nécessaire.",
      },
      {
        title: "Injection",
        description: "Injections multiples de toxine botulique dans la zone à traiter.",
      },
      {
        title: "Suivi",
  ...
  video: {
    title: "Le traitement de l'hyperhidrose en vidéo",
    videoId: "yyQ30IDZFFA",
  },
  results: {
    title: "Résultats",
    subtitle: "Des transformations significatives",
    videos: [{
      id: '1',
    ...
    items: [
      {
        ...
        location: "Paris",
        rating: 5,
        comment: "Une vraie libération ! Je peux enfin porter des vêtements clairs sans crainte.",
        date: "2024-03-15",
        treatment: "Hyperhidrose",
        verified: true,
      },
      {
        id: 2,
        ...
        location: "Lyon",
        rating: 5,
        comment: "Le traitement a changé ma vie sociale et professionnelle.",
        date: "2024-03-10",
        treatment: "Hyperhidrose",
        verified: true,
      },
