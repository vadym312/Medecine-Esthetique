  ...
  types: {
    ...
    items: [
      ...
      },
      {
        ...
        imageUrl: "/images/injections/peau-relachee.webp",
      },
    ],
  },
  procedure: {
    ...
    steps: [
      ...
      {
        title: "Traitement",
        description: "Micro-injections d'acide hyaluronique sur l'ensemble du visage.",
      },
      {
        title: "Suivi",
        description: "Programme personnalisé de plusieurs séances pour des résultats optimaux.",
      },
    ],
  },
  faq: {
