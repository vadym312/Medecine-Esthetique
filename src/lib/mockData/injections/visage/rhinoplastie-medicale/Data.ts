export const rhinoplastieMedicaleData = {
  ...
  procedure: {
    ...
    steps: [
      {
        title: "Consultation",
        description: "Analyse détaillée de votre nez et définition de vos objectifs.",
      },
      {
        title: "Préparation",
    ...
    items: [
      {
        ...
        location: "Paris",
        rating: 5,
        comment: "Un résultat très naturel qui a transformé mon profil.",
        date: "2024-03-15",
      ...
      },
      {
        ...
        location: "Lyon",
        rating: 5,
        comment: "Très satisfait du résultat, mon nez est parfaitement harmonieux.",
        date: "2024-03-10",
        treatment: "Rhinoplastie médicale",
        verified: true,
      },
