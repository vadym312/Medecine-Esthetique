    ...
    items: [
      {
        ...
        location: "Paris",
        rating: 5,
        comment: "Un résultat très naturel qui a rajeuni mon visage. L'équipe est très professionnelle.",
        date: "2024-03-15",
        treatment: "Sillons nasogéniens",
        verified: true,
      },
      {
        id: 2,
        ...
        location: "Lyon",
        rating: 5,
        comment: "Très satisfaite du résultat, mes sillons sont nettement atténués.",
        date: "2024-03-10",
        treatment: "Sillons nasogéniens",
        verified: true,
      },
