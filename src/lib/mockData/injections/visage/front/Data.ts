export const frontData = {
  ...
  procedure: {
    ...
    steps: [
      {
        title: "Consultation",
        description: "Analyse détaillée de votre front et définition de vos objectifs.",
      },
      {
        title: "Préparation",
      ...
      {
        title: "Traitement",
        description: "Injection précise de produits adaptés pour un résultat naturel.",
      },
      {
        title: "Suivi",
    ...
    items: [
      {
        ...
        location: "Paris",
        rating: 5,
        comment: "Un résultat très naturel qui a effacé mes rides du front. L'équipe est très professionnelle.",
        date: "2024-03-15",
        treatment: "Front",
        verified: true,
      },
    ...
    procedures: [
      {
        ...
        link: "/rhinoplastie-medicale-paris",
      },
      {
        category: "INJECTION",
        title: "MENTON",
