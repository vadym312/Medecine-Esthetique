export const tempesData = {
  hero: {
    ...
    backgroundImage: "/images/tempes.webp",
  },
  intro: {
  ...
  procedure: {
    ...
    steps: [
      {
        title: "Consultation",
        description: "Analyse détaillée de vos tempes et définition de vos objectifs.",
      },
      {
        title: "Préparation",
    ...
    items: [
      {
        ...
        location: "Paris",
        rating: 5,
        comment: "Un résultat naturel qui a transformé mon visage. L'équipe est très professionnelle.",
        date: "2024-03-15",
        treatment: "Tempes",
        verified: true,
      },
      {
        ...
        location: "Lyon",
        rating: 5,
        comment: "Très satisfaite du résultat, mes tempes sont parfaitement symétriques.",
        date: "2024-03-10",
        treatment: "Tempes",
        verified: true,
      },
