export const mentonData = {
  hero: {
    ...
    backgroundImage: "/images/menton.webp",
  },
  intro: {
  ...
  procedure: {
    ...
    steps: [
      {
        title: "Consultation",
        description: "Analyse détaillée de votre menton et définition de vos objectifs.",
      },
      {
        title: "Préparation",
    ...
    items: [
      {
        ...
        location: "Paris",
        rating: 5,
        comment: "Un résultat très naturel qui a transformé mon profil. L'équipe est très professionnelle.",
        date: "2024-03-15",
        treatment: "Menton",
        verified: true,
      },
      {
        ...
        location: "Lyon",
        rating: 5,
        comment: "Très satisfaite du résultat, mon visage est parfaitement harmonieux.",
        date: "2024-03-10",
        treatment: "Menton",
        verified: true,
      },
