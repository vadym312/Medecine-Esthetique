...
export const defaultMetadata: Metadata = {
    ...
    openGraph: {
        ...
        description: "Découvrez comment les injections d'acide hyaluronique redonnent du volume à vos pommettes pour un visage rajeuni et harmonieux. Techniques, résultats et précautions.",
        locale: 'en_US',
        url: "https://medecine-esthetique.net/injection-acide-hyaluronique-pommettes-paris/",
    ...
    alternates: {       
        canonical: `${process.env.NEXT_PUBLIC_SITE_URL}/injection-acide-hyaluronique-pommettes-paris`,
        languages: {
